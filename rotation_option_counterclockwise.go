...
func (r *rotationOptionCounterClockwise) Left() {
	var (
		front = r.cube.front.colors
		back  = r.cube.back.colors
		left  = r.cube.left.colors
...
func (r *rotationOptionCounterClockwise) Right() {
	var (
		front = r.cube.front.colors
		back  = r.cube.back.colors
		right = r.cube.right.colors
...
func (r *rotationOptionCounterClockwise) Up() {
	var (
		front = r.cube.front.colors
		back  = r.cube.back.colors
		left  = r.cube.left.colors
...
func (r *rotationOptionCounterClockwise) Down() {
	var (
		front = r.cube.front.colors
		back  = r.cube.back.colors
		left  = r.cube.left.colors
